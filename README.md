...
* **Character Sprites:** Custom-designed "malware" zombie variants representing different system threats.
* **Tower Nodes:** Pixel art defense structures representing CPU processing units and security protocols.
